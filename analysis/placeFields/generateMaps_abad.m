function [map,stats] = generateMaps_abad(v,z,varargin)
...
if isempty(y)
	...
	valid = map.time > minTime;
% 	map.a = Smooth(Interpolate2(map.x,map.y,map.count,valid,mode,maxDistance),smooth,'type',type(1:2))';
% 	map.t = Smooth(Interpolate2(map.x,map.y,map.time,valid,mode,maxDistance),smooth,'type',type(1:2))';
